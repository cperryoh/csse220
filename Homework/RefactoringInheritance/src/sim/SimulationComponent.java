...
import simulationObjects.PersonState;
...
public class SimulationComponent extends JComponent {
	...
	public void addPeople(int count) {
		...
		for (int i = 0; i < count - 1; i++) {
			this.persons.add(new Person(rand.nextInt(this.getWidth()), rand.nextInt(this.getHeight()),PersonState.Healthy));
		}
		this.persons.add(new Person(rand.nextInt(this.getWidth()), rand.nextInt(this.getHeight()), PersonState.Infected));
